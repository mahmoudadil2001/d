...
async function loadMyFriends() {
  ...
  sortedFriends.forEach((friend) => {
    ...
    if (status) {
      if (status.isOnline) { // Check for 'isOnline' property
        onlineFriends++;
...
async function updateOnlineFriendsBadge() {
  ...
  friendsManager.friends.forEach((friend) => {
    const status = friendsStatus[friend.uid];
    if (status && status.isOnline) { // Check for 'isOnline' property
      onlineCount++;
    }
  });
      ...
      <div style="padding: 25px; color: white; font-family: 'Tajawal', sans-serif; line-height: 1.6;">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; margin: 25px 0;">
          ...
          " onclick="window.open('https://instagram.com/io_622', '_blank', 'noopener,noreferrer')">
            <div style="margin-bottom: 8px; display: flex; justify-content: center;">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                <path d="M12 2.163C15.204 2.163 15.584 2.175 16.85 2.233C20.102 2.381 21.621 3.924 21.769 7.152C21.827 8.417 21.838 8.797 21.838 12.001C21.838 15.206 21.826 15.585 21.769 16.85C21.62 20.075 20.105 21.621 16.85 21.769C15.584 21.827 15.206 21.839 12 21.839C8.796 21.839 8.416 21.827 7.151 21.769C3.891 21.62 2.38 20.07 2.232 16.849C2.174 15.584 2.162 15.205 2.162 12C2.162 8.796 2.175 8.417 2.232 7.151C2.381 3.924 3.896 2.38 7.151 2.232C8.417 2.175 8.796 2.163 12 2.163ZM12 7C9.239 7 7 9.239 7 12C7 14.761 9.239 17 12 17C14.761 17 17 14.761 17 12C17 9.239 14.761 7 12 7ZM18.406 6.594C18.406 5.853 17.8 5.247 17.059 5.247C16.318 5.247 15.712 5.853 15.712 6.594C15.712 7.335 16.318 7.941 17.059 7.941C17.8 7.941 18.406 7.335 18.406 6.594C18.406 5.853 17.8 5.247 17.059 5.247C16.318 5.247 15.712 5.853 15.712 6.594C15.712 7.335 16.318 7.941 17.059 7.941C17.8 7.941 18.406 7.335 18.406 6.594ZM12 9C13.657 9 15 10.343 15 12C15 13.657 13.657 15 12 15C10.343 15 9 13.657 9 12C9 10.343 10.343 9 12 9Z" fill="url(#gradient)"/>
                <defs>
